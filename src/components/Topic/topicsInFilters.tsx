...
const TopicsInFilters = () => {
  ...
  if (isLoading) {
    return (
      <button className="h-[2rem] w-[4rem] rounded border px-3">
  ...
  return topics?.map((topic) => (
    <Link
      className="w-auto rounded border p-[2%] text-sm font-medium capitalize hover:bg-gray-100 lg:text-base lg:font-normal"
